...
for i in range(1):
    ...
    error_times_std.append(round(np.std(times[i])/math.sqrt(30),2))
    error_costs_mean.append(round(statistics.mean(costs[i]),2))
    error_costs_std.append(round(np.std(costs[i])/math.sqrt(30),2))
    error_expansions_mean.append(round(statistics.mean(expansions[i]),2))
    error_expansions_std.append(round(np.std(expansions[i])/math.sqrt(30),2))
